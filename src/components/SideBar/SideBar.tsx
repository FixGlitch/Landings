...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  useEffect(() => {
    const storedExpandedState = localStorage.getItem("sidebar-expanded") === "true";
  ...
  return (
    ...
    >
      <div className="flex items-center justify-start gap-2 px-6 py-2 lg:py-6">
        <Link href="/">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={pathname === "/" || pathname.includes("nicio")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-primary duration-300 ease-in-out hover:text-aquamarine-300 ${
